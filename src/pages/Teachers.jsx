  ...
  return (
    <div className="min-h-screen bg-[#f5f6ff] p-4 sm:p-8 font-sans">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-8">
       ...
       <Link  to="/add-teacher">   <button className="w-full sm:w-[207px] h-[46px] sm:h-[60px] rounded-[40px] px-6 sm:px-[43px] py-2 sm:py-[16px] bg-[#4D44B5] shadow-[0px_20px_50px_0px_#BF156C0D] text-white font-bold transition hover:bg-[#3b3590]">
            + New Student
          </button> </Link>
        </div>
      </div>
